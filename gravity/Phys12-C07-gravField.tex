...
otherwise it is impossible. But we can skip over to the final result: the work
done by gravitational foce $U_g$ is
the gravitational potential energy stored between masses $m_1$ and $m_2$,
defined as:
\begin{important-equation}
  U_g=-\frac{Gm_1m_2}r
