...
\item Air is made up primarily of nitrogen and oxygen. In an enclosed room
  ...
  \item The nitrogen gas molecules have a lower average kinetic energy than
    the oxygen gas molecules.
  \item More information is necessary to compare the average kinetic
...
\item Air is made up primarily of nitrogen and oxygen. In an enclosed room
  ...
  concerning the nitrogen and oxygen gases?
  \begin{enumerate}
  \item The nitrogen gas molecules have a higher velocity than the oxygen
    gas molecules.
...
\item Two identical rooms are connected by an open door. The temperature in one
  room is greater than the temperature in the other. Which room contains
...
\item In an experiment, a gas is confined in a cylinder with a movable
  ...
  %  the gas.
  %  \item The vertical axis can be used to calculate the force the gas
  %  exerts on the container.
  %  \item The $x$-intercept can be used to estimate the value of absolute
  %  zero.
  %\end{enumerate}
  
\item Two sealed cylinders holding different gases are placed one on top
  ...
  \begin{enumerate}
  \item Net heat flows from cylinder A to cylinder B, because heat flows
    from higher kinetic energy atoms to lower kinetic energy atoms.
  \item Net heat flows from cylinder B to cylinder A, because heat flows
    from higher kinetic energy atoms to lower kinetic energy atoms.
  \item There is no net heat transfer between the two cylinders, because
  ...
  \begin{center}
    \pic{.33}{thermodynamics/homework/mc-q26}
  \end{center}
\item The graph above shows the distribution of speeds for one mole of
...
%  \item What is the volume of one mole of ideal gas at \SI{300}{\kelvin}
...
\item The specific heat capacity of air at \SI0{\celsius} is
  ...
  \begin{enumerate}
  \item what is its specific heat capacity at \SI0{\celsius} at constant volume?
  \item How much internal energy is there in 1 L of air at \SI0\celsius?
  \end{enumerate}

\item One mole of a ideal diatomic gas is heated at constant volume from
  300 to \SI{600}\kelvin.
  \begin{enumerate}
  \item Find the increase in internal energy, work done, and heat added
    
  \item Find the same quantities if the gas is heated at constant pressure.
    (Use the first law of thermodynamic.)% and your results in part (a) to
    %calculate the work done.)
    %
    %\item Calculate the work done in part (b) directly using the definition of
    %work.
  \end{enumerate}
  
\item A piece of ice is dropped from a height $H$.
  \begin{enumerate}
  \item Find the minimum value of $H$ such that all the ice melts when it
  ...
  \item Is it reasonable to neglect the variation in the acceleration of
    gravity in doing this problem

  \item Comment on the reasonableness of neglecting air resistance (drag). What
    effect would air resistance have on your answer to part (a)?
  \end{enumerate}

\item A \SI{450}{\milli\litre} cup of coffee is too hot to drink at
  \SI{91}\celsius, so \SI{100}{\milli\litre} of cold water at
  \SI{6.5}{\celsius} is added to cool it off.
  \begin{enumerate}
  \item What is the final temperature of the drink?
  \item What assumptions do you have to make in order to solve this problem?
  \end{enumerate}
...
\item An experiment is performed to determine the number $n$ of moles of
  ...
  \item Using your graph and the values $A=\SI{.027}{\metre\squared}$ and
