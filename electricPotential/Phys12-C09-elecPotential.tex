...
both the magnitude and direction of $\mathbf F_q$ changes. Therefore, calculating
...
\begin{equation}
  ...
  \int_{\mathbf r_1}^{\mathbf r_2}\mathbf F_q\cdot \dl{\mathbf r}}_\text{definition using
      calculus}
...
\begin{definition}
  ...
  \item When the work done by $\mathbf F_q$ is \emph{positive}, there is a
    \emph{decreases} in electric potential energy by the same amount
  \item When the work done by $\mathbf F_q$ is \emph{negative}, there is an
...
%
%
%\section{Relating $U_q$, $\mathbf F_q$ and $\mathbf E$}
%  From the work-energy theorem:
%  \begin{itemize}  
%  \item Electrostatic force $\mathbf F_q$ always points from high to low potential
%    energy
%  \item Similarly, electric field $\mathbf E$ points from high to low electric
%    potential
...
\begin{center}
  ...
  \end{tikzpicture}
\end{center}
The electric field $\mathbf E$ between two charged parallel plates is uniform at
...
$\mathbf E$ outside the plates is nearly zero, except for the fringe effects
