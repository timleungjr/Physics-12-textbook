...
\item A straight wire carries a current $I$ as shown. The magnetic field $B$ at
  point $P$, distance $r$ above the wire is
  \begin{center}
  ...
  \end{center}
  \begin{enumerate}
  \item $2\pi rI$ directed into the page
  \item $\mu_0I$ directed out of the page
  \item $\dfrac{\mu_0I}{2\pi r}$ into the page
  \item $\dfrac{\mu_0I}{2\pi r}$ out of the page
  \item zero
  \end{enumerate}
...
%%  Sphere $B$?
%%  \begin{enumerate}
%%    \item Each sphere has the same mass.
%%    \item Sphere A has \SI{7.29e-25}{\kilo\gram} more mass than Sphere B.
