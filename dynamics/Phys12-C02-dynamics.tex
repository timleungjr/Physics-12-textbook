...
In Newtonian---also known as ``classical''---physics, \textbf{gravity} is the
mutual attraction between all massive objects. The gravitational force that
objects apply to each other can be expressed as:
\begin{important-equation}
  \bm F_g=m\bm g
\end{important-equation}
...
considerably more depth in Chapter~\ref{chapter:gravity}. If gravitational force
is the only force that acts on an object, the object is in a \textbf{free fall}.
...
\begin{remark}
  Since 1915, when Einstein published his paper on the theory of general
  relativity, we have a deeper understanding of gravity. All masses cause
  space and time to warp in its vicinity, and the warpping of spacetime pulls
  other objects towards it, giving it the appearance of a force.
\end{remark}
...
\begin{figure}[ht]
  ...
  \end{tikzpicture}
  \caption{Direction of the spring force is always opposite to the spring's
    displacement}
\end{figure}
...
\begin{figure}[ht]
  ...
  \end{subfigure}
  \caption{Examples of objects moving through a fluid}
\end{figure}
