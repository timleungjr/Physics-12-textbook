...
pressure over the entire surface to find the total buoyant force $\bm F_B$ the
fluid exerts on the object. The expression is surprisingly simple:  
\begin{equation}
  \boxed{
    \bm F_B=\rho_\text{fluid}gV\hat z=m_\text{fluid}g\hat z
  }
\end{equation}
...
%
%  \eq{0in}{
%    \boxed{\bm B = \rho_\text{fluid}gV\hat z=
