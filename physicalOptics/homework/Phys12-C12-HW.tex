...
%
%\item An ocean wave diffracts as it travels through an opening in a barrier in
%  a harbour. Which of the following variables can be altered to change the
%  amount of diffraction the wave experiences? (The amount of diffraction refers
%  to the spacing between fringes.)
...
\item As a student is performing a double slit experiment to determine the
  ...
  \begin{enumerate}
  \item decrease the slit separation
  \item decrease the distance between the slits and the screen
  \item move the light source closer to the slits
  \item both A and B
  \item A, B and C
  \end{enumerate}
...
\item The brightest and clearest diffraction patterns are seen when light is
  shone through:
  \begin{enumerate}
  \item a single slit
  \item a double slit
  \item a diffraction grating
  \item a polarizing filter
  \item a thin soap film
  \end{enumerate}
  
\item The greater the number of lines on a diffraction grating of a given size,
  \begin{enumerate}
  \item the greater the range of wavelengths that can be diffracted
  \item the smaller the range of wavelengths that can be diffracted
  \item the greater the distance between the bright fringes produced
  \item the smaller the distance between the bright fringes produced
  \item the less clear the diffraction pattern will be
  \end{enumerate}
...
\item Upon observing an interference pattern produced onto a screen, how could
  you identify whether a single slit or double slit produced the pattern?
...
\item The signal from a \SI{103.9}{\mega\hertz} FM radio station reflects off a
  building \SI{400}{\metre} away, effectively creating two sources of the same
  signal. You are driving at \SI{60}{\kilo\metre\per\hour} along a road
